...
#####Create an interface in the order class, to create a new menu, aggregate the 
#####functions for add, update, delete items. All the menus should be stored as JSON files. (use dicts for this task.)
